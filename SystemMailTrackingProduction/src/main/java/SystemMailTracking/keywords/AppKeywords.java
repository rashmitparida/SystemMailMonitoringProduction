...
public class AppKeywords extends GenericKeywords{
	...
	public void verifyAddingNewContact()
	{
		...
		click("CreateNewContactProdButton_xpath");
		...
		try
		 {
			...
			driver.findElement(By.xpath("//*[@id='DataTables_Table_0']/tbody/tr[1]/td[@class='contactAction font-size-13']//a[3]/i")).click();
	...
	public void VerifyBroadcastEmailFromInbox()
	{
		try
		{
			...
			test.log(Status.INFO, "Broadcast email is sent successfully");
		}
		catch (Throwable t)
		{
...
public void VerifyBroadcastMailContacts()
	{
